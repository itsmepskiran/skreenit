...
import { jobService, applicationService, realtimeService } from './api-services.js'
...
async function checkAuth() {
  ...
  candidateName && (candidateName.textContent = currentUser.user_metadata?.full_name || 'Candidate')
