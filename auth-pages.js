...
export async function handleRegistrationSubmit(e) {
  ...
  try {
    ...
    if (!emailRes.ok) {
      console.warn('Email not sent. Provide password manually.')
      alert(`Registered successfully. Temporary password: ${tempPassword}`)
    }
...
export async function handleLoginSubmit(e) {
  ...
  try {
    ...
    if (role === 'candidate') {
      window.location.href = 'candidate-dashboard.html#profile'
